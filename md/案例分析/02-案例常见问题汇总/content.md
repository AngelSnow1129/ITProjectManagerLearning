...
> **说明**：本文档整合了历年高级信息系统项目管理师考试中的76个经典案例问题，涵盖十大管理领域的常见错误和改进措施。通过学习这些案例，可以快速掌握项目管理中的常见问题识别方法。

## 📋 目录结构

本文档按照案例编号顺序组织，每个案例包含：
- **案例描述**：简要说明案例中的问题情境
- **问题分析**：列出该案例中存在的项目管理问题
- **考试年份**：标注该案例的出处
...
**案例描述**：
因人手比较紧张，M从正在从事编程工作的高手中选择了小张作为负责软件子项目的项目经理，小张同时兼任模块的编程工作。
...
**案例描述**：
在验收过程中，老刘提出了一些小问题。项目经理张斌带领团队很快妥善解决了这些问题，但是随着时间的推移，客户的问题似乎不断。时间已超过系统试用期，但是客户仍然提出一些小问题，而有些问题都是客户方曾经提出过的，并实际上已经解决了的问题。
...
**案例描述**：
项目经理小丁做过5年的系统分析和设计工作，但这是他第一次担任项目经理，小丁兼任系统分析工作。
...
**案例描述**：
因此他要求项目组成员无论如何每周都必须按时参加例会并发言，但对例会具体应如何进行，老张却不知道如何规定。很快项目组成员就开始抱怨例会的不明，时间太长，效率太低，缺乏效果等等，而且由于在例会上意见相左，很多组员开始相互争吵，甚至影响了人际关系的融洽。
...
**案例描述**：
在该项目合同中，简单地列出了几条项目承建方应完成的工作，据此小李自己制定了项目的范围说明书。
...
**案例描述**：
项目承建单位的一名副总裁承揽了一个新项目，他把程序员、测试工程师从该项目上调走，去执行他新承揽的项目。
